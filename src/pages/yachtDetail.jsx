    ...
    <div className="max-w-7xl mx-auto my-12 p-10 bg-white rounded-lg shadow-lg flex flex-col md:flex-row gap-10">
      ...
      <div className="md:w-1/2 flex flex-col justify-between">
        <div>
          ...
          {/* Embarque y capacidad juntos en desktop */}
...
{/* Especificaciones - separadas en móvil y desktop */}
<div className="mb-4 md:hidden">
  <span className="flex items-center gap-2 text-gray-600">
            ...
            <div className="flex flex-wrap gap-3">
              {yate.offers.map(offer => (
                <button
                  ...
                  onClick={() => alert(`Has seleccionado la oferta de ${offer.durationHours} horas por $${parseFloat(offer.price).toLocaleString()}`)}
                >
